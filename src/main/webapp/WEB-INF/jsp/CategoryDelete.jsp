	...
	<%@ include file="/WEB-INF/jsp/fragments/header.jsp"%>
		...
		<main role="main">
			...
			<div class="card col-8 col-md-6 col-lg-4" style="background-color: #f2f2f2; margin: auto;">
				...
				<form class="text-center" method="post" action="<%=request.getServletContext().getContextPath() %>/app/category/delete" class="form-signin">

					<br />
					<h1 class="h3 mb-3 font-weight-normal">Validez la suppression de </h1>
					<br/>
					<h2 class="h4 mb-3 font-weight-normal">${category.name} </h2>
					<br/>
